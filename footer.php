			...
			<div class="row mb-5 p-4" style="background: rgba(256, 256, 256, .05);">
				<div class="col-md-4">
					<div class="text-md-center">
						<h5 class="text-primary text-uppercase mb-2" style="letter-spacing: 5px;">Nuestro taller</h5>
						<p class="mb-4 m-md-0">Nueva San Martín 1096, Maipú</p>
					</div><br>
					<div class="text-md-center">
						<h5 class="text-primary text-uppercase mb-2" style="letter-spacing: 5px;">Llámanos</h5>
						<p class="m-0">+569 5969 7897</p>
					</div>
					<br>
					<div class="text-md-center">
						<h5 class="text-primary text-uppercase mb-2" style="letter-spacing: 5px;">Horario de atención</h5>
						<p class="m-0">X am - Y pm</p>
					</div>
					<br>
				</div>
				<div class="col-md-8">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3326.090134052772!2d-70.7741152849821!3d-33.52504210873008!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9662dd238b5f39d1%3A0x336c2e71bf198035!2sNueva%20San%20Mart%C3%ADn%201096%2C%20Maip%C3%BA%2C%20Regi%C3%B3n%20Metropolitana!5e0!3m2!1ses-419!2scl!4v1678127674036!5m2!1ses-419!2scl" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
				<div class="col-md-4">
				</div>
			</div>
...
<div class="container-fluid bg-dark text-white text-center border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .05) !important;">
  <p class="m-0 text-white">&copy; <a href="#">Paradis Service</a>. All Rights Reserved. Designed by <a target="_blank" href="https://htmlcodex.com">HTML Codex</a>. Implementado por <a href="https://cvillavicencio.com" target="_blank">cvillavicencio.com</a>.</p>
</div>
<!-- Footer End -->
