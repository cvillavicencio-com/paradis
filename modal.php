<!-- Modal mantencion -->
<div class="modal fade" id="mantencion" tabindex="-1" role="dialog" aria-labelledby="mantencion"
     aria-hidden="true">
...
<!-- Modal reparacion -->
<div class="modal fade" id="reparacion" tabindex="-1" role="dialog" aria-labelledby="reparacion"
     aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<!-- Modal repuestos -->
<div class="modal fade" id="repuestos" tabindex="-1" role="dialog" aria-labelledby="repuestos"
     aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
